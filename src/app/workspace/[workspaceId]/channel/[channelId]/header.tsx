          ...
          <div className="px-4 pb-4 flex flex-col gap-y-2">
            ...
            {member?.role === "admin" && (
              <Button
                ...
                className="flex items-center gap-x-2 px-5 py-4 bg-white rounded-lg cursor-pointer border hover:text-gray-50 text-rose-600"
              >
                <TrashIcon className="size-4"/>
                <p className="test-sm font-semibold">Delete channel</p>
              </Button>
            )}
          </div>
        </DialogContent>
